...
public class Task1 {
    ...
    public static String sortByNumbersOfSentencesInParagraph(String str){
    ...
    public static String sortByLengthOfWordsInSentences(String str){
    ...
    public static String sortByNumberOfKeysInWords (String str, String key){
    ...
    public static int countOfKeysInWord(String str, String key){
