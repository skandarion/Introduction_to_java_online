package com.company.epam.introduction_to_java_online.tasks.task3.client;
...
public class Client {
    ...
    public static void logIn() throws IOException {
        ...
        while(true) {
            ...
            String login = com.company.epam.introduction_to_java_online.tasks.task3.client.SideUtils.readString();
            System.out.println("enter your password: ");
            String password = com.company.epam.introduction_to_java_online.tasks.task3.client.SideUtils.readString();
