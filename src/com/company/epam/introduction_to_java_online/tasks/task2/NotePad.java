...
import com.company.epam.introduction_to_java_online.classes.simple_classes.task8.ComparatorByName;
import com.company.epam.introduction_to_java_online.tasks.task2.comps.CompByEmail;
import com.company.epam.introduction_to_java_online.tasks.task2.comps.CompByMessage;
import com.company.epam.introduction_to_java_online.tasks.task2.comps.CompByTopic;
...
public class NotePad {
    ...
    public void createNote() {
        ...
        String s1 = com.company.epam.introduction_to_java_online.tasks.task2.SideUtils.readString();
        System.out.println("enter email");
        String s2 = com.company.epam.introduction_to_java_online.tasks.task2.SideUtils.readString();
        System.out.println("enter message");
        String s3 = com.company.epam.introduction_to_java_online.tasks.task2.SideUtils.readString();
    ...
    private void sorting(ArrayList<Note> list) {
        System.out.println("1. sort by topic\n" +
                ...
                "3. sort by email\n" +
                "4. sort by message\n");
        int choice = com.company.epam.introduction_to_java_online.tasks.task2.SideUtils.readInt();
        switch (choice) {
            case 1: {
